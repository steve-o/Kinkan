...
#ifdef KINKANMIB_H
		friend Netsnmp_Next_Data_Point kinkanClientTable_get_next_data_point;
		friend Netsnmp_Node_Handler kinkanClientTable_handler;

		friend Netsnmp_Next_Data_Point kinkanClientPerformanceTable_get_next_data_point;
		friend Netsnmp_Node_Handler kinkanClientPerformanceTable_handler;
#endif /* KINKANMIB_H */
