...
kinkan::client_t::client_t (
	std::shared_ptr<kinkan::provider_t> provider,
	Delegate* delegate, 
	RsslChannel* handle,
	const char* address
	) :
 ...
 */
bool
kinkan::client_t::OnLoginRequest (
	RsslDecodeIterator* it,
...
bool
kinkan::client_t::OnLoginAttribInfo (
 ...
 */
bool
kinkan::client_t::OnDirectoryRequest (
	RsslDecodeIterator* it,
	const RsslRequestMsg* request_msg
	)
{
...
bool
kinkan::client_t::OnDictionaryRequest (
	RsslDecodeIterator* it,
	const RsslRequestMsg* request_msg
	)
{
 ...
 */
bool
kinkan::client_t::SendDirectoryRefresh (
	int32_t request_token,
...
bool
kinkan::client_t::SendDirectoryUpdate (
